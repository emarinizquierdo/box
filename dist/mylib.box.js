...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('box', '<div class="box-cover"> <color onclick="{toggleColorPicker}"></color> <color-picker></color-picker> <div>', 'box .box-cover,[riot-tag="box"] .box-cover{ display: inline-block; width: 50px; height: 50px; border: 2px solid #0E0E0E; border-radius: 7px; position: relative; }', '', function(opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('color', '<div id="boxColor" class="box-color"><div>', 'color .box-color,[riot-tag="color"] .box-color{ width: 100%; height: 100%; background-color: red; cursor: pointer; -webkit-transition: all 0.2s ease-out; -moz-transition: all 0.2s ease-out; -ms-transition: all 0.2s ease-out; -o-transition: all 0.2s ease-out; transition: all 0.2s ease-out; }', '', function(opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('color-picker', '<ul class="box-color-picker {opened : opened}"> <li class="{color.color}" each="{color in colors}" onclick="{setColor}"></li> </ul>', 'color-picker .box-color-picker,[riot-tag="color-picker"] .box-color-picker{ position: absolute; width: 74px; height: 18px; top: 0; left: 50px; border: 1px solid; list-style-type: none; padding: 0; vertical-align: middle; overflow: hidden; width: 0; -webkit-transition: all 0.2s ease-out; -moz-transition: all 0.2s ease-out; -ms-transition: all 0.2s ease-out; -o-transition: all 0.2s ease-out; transition: all 0.2s ease-out; } color-picker .box-color-picker.opened,[riot-tag="color-picker"] .box-color-picker.opened{ width: 74px; } color-picker .box-color-picker li,[riot-tag="color-picker"] .box-color-picker li{ float: left; border: 1px solid; display: inline-block; width: 10px; height: 10px; margin: 3px; cursor: pointer; } color-picker .box-color-picker li.red,[riot-tag="color-picker"] .box-color-picker li.red{ background-color: red; } color-picker .box-color-picker li.green,[riot-tag="color-picker"] .box-color-picker li.green{ background-color: green; } color-picker .box-color-picker li.blue,[riot-tag="color-picker"] .box-color-picker li.blue{ background-color: blue; } color-picker .box-color-picker li.yellow,[riot-tag="color-picker"] .box-color-picker li.yellow{ background-color: yellow; }', '', function(opts) {
